...
Username
<br/>
<input style="width:1200px; padding-top:5px; padding-bottom:5px;" type="text" id="loginUN" name="LoginUsername"/>
<br/><br/><br/>
Password 
<br/>
<input style="width:1200px; padding-top:5px; padding-bottom:5px;"  type="password" id="loginPass" name="LoginPassword"/>
<br/><br/>
<div style="color:red;"> ${errormess1} </div>
<input  style="width:1210px; padding-top:5px; padding-bottom:5px; background-color:#AAAAAA; color:white; font-size:20px;" type="submit" name = "butt" value="Sign In"/>
</form>
