...
{
    //create book product
    Product* books = new Book(ProductBookParser::categoryID(), prodName_, price_, qty_, author_, isbn_);
   return books;
...
Product* ProductClothingParser::makeProduct()
{
    ...
    Product* clothes = new Clothing(ProductClothingParser::categoryID(), prodName_, price_, qty_, size_, brand_);
...
{
    //create movie product
    Product* movies = new Movie(ProductMovieParser::categoryID(), prodName_, price_, qty_, genre_, rating_);
   return movies;
