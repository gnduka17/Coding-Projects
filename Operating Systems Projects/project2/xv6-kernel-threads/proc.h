...
enum threadstate { TUNUSED, TEMBRYO, TSLEEPING, TRUNNABLE, TRUNNING, TZOMBIE, TINVALID, TBLOCKED }; //state of thread
enum mutexstate{MUNUSED, MLOCKED, MUNLOCKED};                           // state of mutex object.
