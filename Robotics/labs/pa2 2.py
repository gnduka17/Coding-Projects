...
#         self.arm.set_color(0.0,0.0,0.0)
         print("anglefirst",angle1)
         print("anglesec",math.degrees(angle2))
...
#         self.time.sleep(4)
         ...
         angle1 = math.atan2(1.0-0.307,-0.3)-b-math.pi/2
         self.arm.set_color(0.0,0.0,0.0)
         print("anglefirst2",-1*angle1)
         print("anglesec2",math.degrees(-1*angle2))
         self.arm.disable_painting()
...
#         self.time.sleep(4)
         ...
         self.arm.set_color(0.0,0.0,0.0)
         print("anglefirst3",-1*angle1)
         print("anglesec3",math.degrees(-1*angle2))
         self.arm.disable_painting()
         self.arm.go_to(1,-1*angle1);
#         self.time.sleep(2)
         self.arm.go_to(3,-1*angle2);
...
#         self.time.sleep(4)
         ...
         angle1 = math.atan2(0.9-0.307,-0.3)-b-math.pi/2
         self.arm.set_color(0.0,0.0,0.0)
         print("anglefirst4",-1*angle1)
         print("anglesec4",math.degrees(-1*angle2))
         self.arm.disable_painting()
         self.arm.go_to(1,angle1);
#         self.time.sleep(2)
         self.arm.go_to(3,angle2);
